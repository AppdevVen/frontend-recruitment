      ...
      <q-page class="fit row wrap justify-center items-center content-center login-container">
        <div class="login-card">
          ...
          <div class="logo-section">
            ...
            <h1 class="app-title">
              <span class="title-gradient">Recruitment Barcode</span>
            </h1>
...
const onSubmit = async (values, actions) => {
  try {
    ...
    window.localStorage.setItem("site", res.data.data.site);
    window.localStorage.setItem("unit", res.data.data.unit);
